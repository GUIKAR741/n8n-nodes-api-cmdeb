...
export const propertiesConfig: INodeProperties[] = [
    ...
    // ─── Matrículas ───────────────────────────────────────────────────────────
    {
        ...
        options: [
            ...
            {name: 'Edição de Enturmação (Lote)', value: 'editEnturmacaoMatriculasLote'},
        ],
    ...
    // ─── Frequência Mensal ────────────────────────────────────────────────────
    {
        ...
        options: [
            ...
            {name: 'Matrículas Inativas com Frequências (Lote)', value: 'createFrequenciaMatriculasInativasLote'},
        ],
    ...
    // ─── Profissionais ────────────────────────────────────────────────────────
    {
        ...
        options: [
            ...
            {name: 'Vincular a Turma/Componente (Lote)', value: 'createProfissionaisEnturmacaoLote'},
            {name: 'Edição de Enturmação (Lote)', value: 'editProfissionaisEnturmacaoLote'},
            {name: 'Listagem', value: 'listProfissionais'},
            {name: 'Listagem de Alocações', value: 'listProfissionaisEnturmacao'},
        ],
