...
export async function listValidacoesCadastrais(
    ...
    try {
        ...
        const st_cadastro_validado = context.getNodeParameter('st_cadastro_validado', index, '') as string | number;
        const dt_validacao_inicio = context.getNodeParameter('dt_validacao_inicio', index, '') as string;
        const dt_validacao_fim = context.getNodeParameter('dt_validacao_fim', index, '') as string;
